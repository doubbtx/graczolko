module.exports = {
    ...
    everydayItems: [
        ...
        { word: "Ahri", hint: "Uwodząca Lisica" },
        { word: "Ambessa", hint: "Brutalna przywódczyni Noxusu" },
        { word: "Bard", hint: "Zbiera dzwoneczki" },
        { word: "Blitzcrank", hint: "Parowy golem z rakietową ręką" },
        { word: "Briar", hint: "Stupki" },
        { word: "Corki", hint: "Miał niemiecki skin" },
        { word: "Elise", hint: "Pani Pająk" },
        { word: "Evelynn", hint: "Najlepsza postać w lidze" },
        { word: "Gragas", hint: "Pijak z bebzonem" },
        { word: "Gwen", hint: "Lalka z nożyczkami" },
        { word: "Janna", hint: "Prezenterka Pogody z Summoners Rift" },
        { word: "Kassadin", hint: "PERMABAN" },
        { word: "Jax", hint: "Pdf z górnej Alei" },
        { word: "Kayle", hint: "Nie istnieje do 16 poziomu" },
        { word: "Kennen", hint: "Mały rzuca Szurikenem" },
        { word: "Lulu", hint: "Dziwka z kapeluszem" },
        { word: "Nami", hint: "Jestem Syrenką" },
        { word: "Nidalee", hint: "Meow" },
        { word: "Nunu", hint: "Toczy kule" },
        { word: "Qiyana", hint: "Kijanka" },
        { word: "Ryze", hint: "CHINESE 400CS/10MIN DOINB HACK" },
        { word: "Senna", hint: "Śpiąca" },
        { word: "Shaco", hint: "Marsz Marsz Marsz" },
        { word: "Soraka", hint: "Łap Banana" },
        { word: "Sylas", hint: "Kradnie ale nie jest czarny" },
        { word: "Mel", hint: "Zabiła Maddie" },
        { word: "Yasuo", hint: "0/12 powerspike" },
        { word: "Zed", hint: "Faker, Faker, What was that" },
    ],
